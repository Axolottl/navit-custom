...
void	module_binding_dbus_init(void);
void	module_binding_python_init(void);
void	module_speech_dbus_init(void);
void	module_speech_cmdline_init(void);
void	module_vehicle_gpsd_dbus_init(void);
...
module_binding_dbus_init();
module_binding_python_init();
module_speech_dbus_init();
module_speech_cmdline_init();
module_vehicle_gpsd_dbus_init();
